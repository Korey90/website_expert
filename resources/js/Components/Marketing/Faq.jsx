...
const DEFAULTS = {
    ...
    items: [
        ...
        { question_en: 'How much does a website cost?', question_pl: 'Ile kosztuje strona internetowa?', question_pt: 'Quanto custa um website?', answer_en: 'Brochure websites and e-commerce projects have clear starting prices shown in your local currency. We always provide a fixed-price quote - no surprises.', answer_pl: 'Ceny startowe stron wizytówkowych i sklepów pokazujemy w Twojej lokalnej walucie. Zawsze podajemy stałą cenę - bez niespodzianek.', answer_pt: 'Os preços iniciais para sites institucionais e e-commerce são apresentados na sua moeda local. Fornecemos sempre um orçamento de preço fixo - sem surpresas.' },
