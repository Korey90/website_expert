...
export default function CtaBanner({ data }) {
    ...
    return (
        <section id="cta-main" className="py-16 bg-neutral-950 dark:bg-neutral-900 relative overflow-hidden">
            {/* Subtle brand ambient */}
            <div className="absolute inset-0 bg-gradient-to-br from-brand-500/10 via-transparent to-transparent" aria-hidden="true" />
            ...
            <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center reveal">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    {secondaryText && secondaryUrl && (
                        <a
                            href={secondaryUrl}
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-neutral-700 text-neutral-300 font-bold text-base hover:border-brand-500 hover:text-brand-500 active:scale-95 transition-all"
                        >
                            {secondaryText}
                        </a>
                    )}
