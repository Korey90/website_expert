        ...
        return match ($slug) {
            ...
            'web-applications' => [
                ...
                'questions' => [
                    ...
                    $this->q('discovery_budget', $isEn ? 'Is client aware of the paid discovery phase and local-currency starting price?' : 'Czy klient jest świadomy płatnego discovery i ceny startowej w lokalnej walucie?', 'boolean', true),
                ],
            ],
            'seo' => [
            ...
            'google-ads' => [
                ...
                'questions' => [
                    ...
                    $this->q('ad_budget', $isEn ? 'Monthly ad spend budget (local currency)' : 'Miesięczny budżet reklamowy (lokalna waluta)', 'text', true),
            ...
            'maintenance' => [
                ...
                'questions' => [
                    ...
                    $this->q('migrate_hosting', $isEn ? 'Interested in migrating to our managed hosting add-on?' : 'Zainteresowanie migracją na nasz managed hosting jako dodatkiem?', 'boolean', false),
                ],
            ],
            default => [
