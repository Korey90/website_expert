    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            ['key' => 'from_label', 'group' => 'misc_labels', 'sort_order' => 20,
                ...
                'note' => 'Prefix before price, e.g. "from {amount}"'],
            ...
            ['key' => 'per_year', 'group' => 'misc_labels', 'sort_order' => 25,
                ...
                'value_pl' => '/rok',
                'value_pt' => '/ano',
                'note' => 'Hosting cost suffix, e.g. "{amount}/year"'],

            ['key' => 'per_month', 'group' => 'misc_labels', 'sort_order' => 26,
                'value_en' => '/mo',
                'value_pl' => '/mc',
                'value_pt' => '/mês',
                'note' => 'Monthly hosting cost suffix, e.g. "{amount}/mo"'],

            ['key' => 'self_managed', 'group' => 'misc_labels', 'sort_order' => 27,
                'value_en' => 'self-managed',
                'value_pl' => 'własne zarządzanie',
                'value_pt' => 'autogerenciado',
                'note' => 'Hosting option with no cost — own server'],

            ['key' => 'pages_addon_label', 'group' => 'misc_labels', 'sort_order' => 28,
                'value_en' => 'Each page above 5',
                'value_pl' => 'Każda strona powyżej 5',
                'value_pt' => 'Cada página acima de 5',
                'note' => 'Hint shown on the pages slider step'],

            ['key' => 'pages_chip', 'group' => 'misc_labels', 'sort_order' => 29,
                'value_en' => 'pages',
                'value_pl' => 'podstron',
                'value_pt' => 'páginas',
                'note' => 'Badge on result screen, e.g. "5 pages"'],

            ['key' => 'integrations_chip', 'group' => 'misc_labels', 'sort_order' => 30,
